...
public class OrderController {
    ...
    @GetMapping("/current")
    public String orderForm(@AuthenticationPrincipal User user, @ModelAttribute("order") Order order){
    ...
    public String processOrder(@Valid @ModelAttribute("order") Order order, Errors errors, SessionStatus sessionStatus,
        ...
        //log.info("Query order by delivery city: " + orderRepo.findByDeliveryCity("HCM"));
        return "redirect:/";
    }
}
